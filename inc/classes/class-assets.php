...
class Assets {
	...
	public function register_styles() {
		...
		wp_register_style( 'fwp-gbe-frontend', FUTUREWORDPRESS_PROJECT_BUILD_CSS_URI . '/frontend.css', [], $this->filemtime( FUTUREWORDPRESS_PROJECT_BUILD_CSS_DIR_PATH . '/frontend.css' ), 'all' );
	...
	public function register_scripts() {
		...
		wp_register_script( 'fwp-gbe-frontend', FUTUREWORDPRESS_PROJECT_BUILD_JS_URI . '/frontend.js', [ 'jquery', 'fullcalendar' ], $this->filemtime( FUTUREWORDPRESS_PROJECT_BUILD_JS_DIR_PATH . '/frontend.js' ), true );
